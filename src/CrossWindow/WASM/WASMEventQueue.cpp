...
bool EventQueue::empty() { return false; }

Event sEvent = Event(EventType::Paint, nullptr);

const Event& EventQueue::front() { return sEvent; }

EM_BOOL EventQueue::keyCallback(int eventType, const EmscriptenKeyboardEvent* e,
                                void* userData)
{
